...
def get_process_pid(
    process_name: str, cmdline_pattern: Optional[List[str]] = None
) -> Optional[int]:
    """
...
def get_ballanime_pigpiod_pids() -> Tuple[Optional[int], Optional[int]]:
    """
...
def collect_memory_usage(
    pid: int, num_samples: int = 10, interval: float = 0.1
) -> List[int]:
    """
